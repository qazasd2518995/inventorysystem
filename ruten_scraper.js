                            ...
                            try {
                                ...
                                if (parentElement) {
                                    ...
                                    const priceSelectors = [
                                        '.rt-text-xx-large.rt-text-important',  // 主要價格顯示
                                        'strong.rt-text-xx-large.rt-text-important',  // 完整選擇器
                                        '.rt-text-important',                    // 重要文字
                                        '.rt-text-xx-large',                     // 大號文字
                                        '.text-price-dollar',                    // 舊版價格選擇器

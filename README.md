...
集中管理源正山 Yahoo 拍賣（賣場名稱：外匯嚴選）與友茂工具露天市集商品，提供商品查詢、Excel 匯出、差異同步與價格異動紀錄。友茂工具不再使用 Yahoo，系統只同步其露天賣場。

## 賣場來源

- 源正山：Yahoo 拍賣「外匯嚴選」（`Y1823944291`）
- 友茂工具：露天市集「U-MO友茂工具賣場」（`u-mo0955900924`）
